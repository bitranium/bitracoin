...
{
    const char* pszTimestamp = "Turkey's own Cryptocurrency Bitranium launching in 26/March/2021";
    const CScript genesisOutputScript = CScript() << ParseHex("090291710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 2 * 60;  //block interval in seconds
        ...
        genesis = CreateGenesisBlock(1616507295, 2000848252, 0x1e0ffff0, 1, 20 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfe034c01c8f885a4a87d904f5102b29d2f322769f0b4c694d7d263da7337391d"));
        assert(genesis.hashMerkleRoot == uint256S("0xbd22e8b40c796224bd0648d979688a6543bf3074dce3d1b2634fd0d4d0de8b10"));
        ...
        vSeeds.emplace_back("2.59.119.35");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.bitraniumtools.com");
        //vSeeds.emplace_back("dnsseed.bitraniumpool.org");
        ...
        checkpointData = {
            {
                {  0, uint256S("0xfe034c01c8f885a4a87d904f5102b29d2f322769f0b4c694d7d263da7337391d")},
...
public:
    CTestNetParams() {
       ...
       // consensus.BIP65Height = 76; // 8075c771ed8b495ffd943980a95f702ab34fce3c8c54e379548bda33cc8c0573
        ...
        consensus.nMinerConfirmationWindow = 2520; // nPowTargetTimespan / nPowTargetSpacing
        //consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
        //consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1199145601; // January 1, 2008
        //consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1230767999; // December 31, 2008
		...
		genesis = CreateGenesisBlock(1616507295, 2069575, 0x1e0ffff0, 1, 20 * COIN);

        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3ce30210088aacbdaea1e1505b58d64703cf592615a48db0a65accda186f9a07"));
        assert(genesis.hashMerkleRoot == uint256S("0xbd22e8b40c796224bd0648d979688a6543bf3074dce3d1b2634fd0d4d0de8b10"));
        ...
        vSeeds.emplace_back("2.59.119.35");
        //vSeeds.emplace_back("seed-b.bitranium.loshan.co.uk");
        ...
        checkpointData = {
            {
                {0, uint256S("0x3ce30210088aacbdaea1e1505b58d64703cf592615a48db0a65accda186f9a07")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1616507295, 0, 0x207fffff, 1, 20 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
		assert(consensus.hashGenesisBlock == uint256S("0x0145c81d15d55ce583110ce82ee556711d3a52aaf035b5d1f64b52f0af7a84fd"));
        assert(genesis.hashMerkleRoot == uint256S("0xbd22e8b40c796224bd0648d979688a6543bf3074dce3d1b2634fd0d4d0de8b10"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x0145c81d15d55ce583110ce82ee556711d3a52aaf035b5d1f64b52f0af7a84fd")},
            }
        };
