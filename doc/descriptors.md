# Support for Output Descriptors in Bitranium Core

Since Bitranium Core v0.17, there is support for Output Descriptors. This is a
...
on Bitranium's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Bitranium Core wallets, a convenience function `combo` is
