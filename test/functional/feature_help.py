...
"""Verify that starting bitranium with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitranium with -h for help text")
        ...
        self.log.info("Start bitranium with -version for version information")
        ...
        self.log.info("Start bitraniumd with -fakearg to make sure it does not start")
