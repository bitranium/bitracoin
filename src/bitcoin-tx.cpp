...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitranium-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitranium-tx [options] <hex-tx> [commands]  Update hex-encoded bitranium transaction\n" +
            "or:     bitranium-tx [options] -create [commands]   Create hex-encoded bitranium transaction\n" +
            "\n";
